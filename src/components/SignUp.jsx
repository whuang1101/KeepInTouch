...
const SignUp = () => {
  ...
  const onEmailBlur = () => {
    ...
    fetch(`https://keepintouch-server-production.up.railway.app/users/email/${newUser.email}`)
  .then((response) => {
  ...
  const onUsernameBlur = () => {
    ...
    fetch(`https://keepintouch-server-production.up.railway.app/users//username/${newUser.username}`)
  .then((response) => {
    return response.json()
  ...
  const handleSignUp = (e) => {
    ...
    if(passwordsMatch && verifyEmail && verifyUsername){
      fetch("https://keepintouch-server-production.up.railway.app/users",{
        method:"POST",
        headers: {
